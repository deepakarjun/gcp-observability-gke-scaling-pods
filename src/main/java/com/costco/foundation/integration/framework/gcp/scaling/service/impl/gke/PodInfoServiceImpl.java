...
public class PodInfoServiceImpl implements PodInfoService {
    ...
    public PodInfoResponse getRunningPods(String projectId, String namespace, String serviceName) {
        try {
            ...
            _log.info("Fetching running pods for service '{}' in namespace '{}' (project '{}')", serviceName, namespace, projectId);

            var labelSelector = "app=" + serviceName;
            var pods = _coreV1Api.listNamespacedPod(namespace).labelSelector(labelSelector).execute();
    ...
    public MinMaxPodResponse getMinMaxPods(String projectId, String namespace, String serviceName) {
        ...
        try {
            ...
            var hpa = _autoscalingV1Api.readNamespacedHorizontalPodAutoscaler(hpaName, namespace).execute();
